...
# MOST IMPORTANT, SETS UP TOPOLOGY
def create_sdn_topology():
    ...
    # Add switches for segment A, segmented cause we wanted to do inter AS at first
    sa_switches = {
...
# this function used to call the controller to get the link to be broken
...
def main():
    ...
    result_file = '/media/sf_rnad/impt/result/resultring.xlsx'
    recovery_times = []
